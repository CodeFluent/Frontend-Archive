...
<thead>
        ...
        <tr class="vdDiscriptionHedings">
            ...
            <th class="vdDis01 vdDisText">Almanac Title</th>
            <th class="vdDis04 vdDisText">Year</th>

           <th class="vdDis04 vdDisText">Library Name</th> 
...
<tbody>
        ...
        <tr class="vdDiscriptionHedings vdAddpadding">
            ...
            <span class="vdcheckBtext"><a href="<?=$EDIT_URL?>&id=<?=$row['id']?>">
...
?>
            ...
            <span class="vdcheckBtext">
			 <?php
$sql_get_library = mysql_query("SELECT * FROM yr15_library WHERE id='".$row['library_id']."'");
$row_get_library = mysql_fetch_array($sql_get_library);
echo $row_get_library['library_name'];
?>
