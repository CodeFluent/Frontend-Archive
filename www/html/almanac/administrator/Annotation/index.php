...
<thead>
        ...
        <tr class="vdDiscriptionHedings">
            ...
            <th class="vdDis04 vdDisText">Description</th>
...
<tbody>
        ...
        <tr class="vdDiscriptionHedings vdAddpadding">
            ...
            <span class="vdcheckBtext"><a href="<?=$EDIT_URL?>&id=<?=$row['id']?>"><?php
...
?></a>
			...
			echo mysql_result($res1,0,'library_name');?></span></td>
            
            <td class="vdDis04" align="center"><span class="vdcheckBtext">
			<?=$row['callnumber']?></span></td>

	    <td class="vdDis04" align="center"><span class="vdcheckBtext">
			<?php
            $sql2="Select * from yr15_annotation_drawtext where annotation_id='".$row['id']."'";
			$res2=mysql_query($sql2);
			echo mysql_result($res2,0,'description');?></span></td>
...
<?php /*?><td class="vdDis04" align="center">
<?php if($row['status']==1) {  ?>
