...

{
	if($row['annotation_type']=='Mark')
	{
		if($mark_id!='')
		{	
			$sql="UPDATE yr15_annotation_mark SET annotation_id='".$_POST['recordId']."',description='".$_POST['description']."' WHERE id='".$mark_id."' "; 
			$query=mysql_query($sql);
		}
		else
		{
			$sql = "INSERT INTO yr15_annotation_mark(annotation_id,description)values('".$_POST['recordId']."','".$_POST['description']."')";
			$query=mysql_query($sql);
		}
	}
	...
	if($row['annotation_type']=='Text' || $row['annotation_type']=='Drawing')
	{
		...
		if($drawtext_id!='')
		{	
			$sql="UPDATE yr15_annotation_drawtext SET annotation_id='".$_POST['recordId']."',description='".$_POST['description']."',annotation_category='".$annotation_category."',child_annotator='".$_POST['child_annotator']."' WHERE id='".$drawtext_id."' "; 
			$query=mysql_query($sql);
		}
		else
		{
			$sql = "INSERT INTO yr15_annotation_drawtext(annotation_id,description,annotation_category,child_annotator)values('".$_POST['recordId']."','".$_POST['description']."','".$annotation_category."','".$_POST['child_annotator']."')";
			$query=mysql_query($sql);
		}
	}
