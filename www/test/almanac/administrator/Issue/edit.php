...
<div class="sepLine"></div>
        ...
        <tr>
        	...
        	<td>
            	...
            	<div class="txtLabel">Editor:</div>

                First Name : <input type="text" id="editor_first_name" name="editor_first_name" style="width:175px;">
                &nbsp;&nbsp;&nbsp;&nbsp;
                Last Name : <input type="text" id="editor_last_name" name="editor_last_name" style="width:175px;">
                &nbsp;&nbsp;&nbsp;&nbsp; OR &nbsp;&nbsp;&nbsp;&nbsp;
                Corporate Name : <input type="text" id="editor_corporate_name" name="editor_corporate_name" style="width:175px;">
                
                <?php if($_GET['id']!=''){?>
				<input type="submit" name="add_editor" value="Add additional Author"><br /><br />
                <?php $res1 = getAgent($_GET['id'],'Editor'); 
				if(mysql_num_rows($res1)>0){?>
...
<div class="sepLine"></div>
        ...
        <tr>
        	...
        	<td>
            	...
            	<div class="txtLabel">Format:</div>
                <select name="format" id="format">
                <option value="">---- Select ----</option>
                <?php
				$sql_get_format = mysql_query("SELECT * FROM yr15_format");
				while($row_get_format = mysql_fetch_array($sql_get_format))
				{
					?>
                    <option value="<?=$row_get_format['format']?>" <?php if($row_get_format['format']==$row["format"]){?>selected="selected"<?php } ?>><?=$row_get_format['format']?></option>
                    <?php
				}
				?>
                </select>
