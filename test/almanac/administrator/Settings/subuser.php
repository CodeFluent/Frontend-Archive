...
header("Location: index.php?layout=subuser");
}
...
<div style="font-size: 16px; font-weight: bold; margin-right: 60px; text-align: right;"><a href="?layout=add-user">Add User</a></div>
...
<?php
$res_subuser = $setting_obj->GET_SUB_USER($_SESSION['adminid']);
...
?>
        ...
        <tr class="vdDiscriptionHedings vdAddpadding">
            ...
            <span class="vdcheckBtext"><a href="?layout=add-user&suid=<?=$row_subuser['id']?>"><?=$row_subuser['name']." ".$row_subuser['lname']?></a><br><?=$row_subuser['email'];?>
			</span>
...
<td class="vdDis04" align="center"><?=$row_subuser['country']?></td>
 ...
 <td class="vdDis04" align="center"><?php
        ...
        <a href="index.php?layout=subuser&sub_action=status&suid=<?=$row_subuser['id']?>&status=0"><img src="../images/enable.png" border="0" alt="Active" /></a>
        <?php } else { ?>
        <a href="index.php?layout=subuser&sub_action=status&suid=<?=$row_subuser['id']?>&status=1"><img src="../images/disable.png" border="0" alt="De-Active" /></a>
        <?php } ?></td>

<td class="vdDis05" align="center">
      <a href="index.php?layout=subuser&sub_action=delete&suid=<?=$row_subuser['id']?>" onClick="if(!confirm('Are you sure, You want delete this record?')){return false;}"><img src="../images/icon_del1.png" width="28" height="24" border="0" alt="Delete" /></a> </td>
